...
public class SimpleServlet extends HttpServlet {
	...
	static final String JDBC_URL = "jdbc:mysql://us-cdbr-iron-east-04.cleardb.net/ad_722846699e6114c?user=be8cdc50bb3240&password=8641e7fb";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			sql = "INSERT INTO User VALUES (\'Raphael Hespanhol\', 30)";
			...
			sql = "DELETE FROM User WHERE name=\'Raphael Hespanhol\'";
			stmt.executeUpdate(sql);
